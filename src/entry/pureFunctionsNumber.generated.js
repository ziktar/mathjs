...
export const cumsum = /* #__PURE__ */ createCumSum({ add, typed, unaryPlus })
...
export const stirlingS2 = /* #__PURE__ */ createStirlingS2({ addScalar, combinations, divideScalar, factorial, isInteger, isNegative, larger, multiplyScalar, number, pow, subtract, typed })
...
export const lgamma = /* #__PURE__ */ createLgamma({ typed })
...
export const std = /* #__PURE__ */ createStd({ map, sqrt, typed, variance })
export const ceil = /* #__PURE__ */ createCeil({ config, round, typed })
export const coth = /* #__PURE__ */ createCoth({ typed })
export const fix = /* #__PURE__ */ createFix({ ceil, floor, typed })
